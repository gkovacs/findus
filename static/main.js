...
(function() {
  var fitMapToPositions, generateUserId, getMarkerIconForUser, googleMap, initializeMap, initializeMapAroundOtherUser, mapInitialized, placeLines, placeMarkers, positionToLink, root, setMapFullscreen, setPositionCookies, updateCurrentPositions, updateCurrentPositionsNoGPS, updatedPositions, userToLine, userToMarker, userid;
  ...
  initializeMapAroundOtherUser = function(userPositions) {
    var currentUserId, latitude, longitude;
    for (currentUserId in userPositions) {
      latitude = userPositions[currentUserId].latitude;
      longitude = userPositions[currentUserId].longitude;
  ...
  updateCurrentPositionsNoGPS = function() {
    return $.get('/getInfo?' + $.param({
      'pageid': 'pageid',
      pageid: pageid
    }), function(data) {
      var allUsers;
